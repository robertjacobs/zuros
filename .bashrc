...
source /opt/ros/hydro/setup.bash && echo "Using ROS Hydro"
source ~/catkin_ws/devel/setup.bash
source ~/catkin_openni_ws/devel/setup.bash
source ~/catkin_depth_to_laser_ws/devel/setup.bash

export ROS_PACKAGE_PATH=/home/robot/git/zuros/zuros_sensors:$ROS_PACKAGE_PATH
export ROS_PACKAGE_PATH=/home/robot/git/zuros/zuros_deliberator:$ROS_PACKAGE_PATH
export ROS_PACKAGE_PATH=/home/robot/git/zuros/zuros_sequencer:$ROS_PACKAGE_PATH
export ROS_PACKAGE_PATH=/home/robot/git/zuros/zuros_control:$ROS_PACKAGE_PATH
export ROS_PACKAGE_PATH=/home/robot/git/zuros:$ROS_PACKAGE_PATH

export ROS_MASTER_URI=http://192.168.1.197:11311/ && echo ROS_MASTER_URI=$ROS_MASTER_URI
export ROBOT=zuros && echo ROBOT=$ROBOT 
export ROBOT_ENV=robot_room && echo ROBOT_ENV=$ROBOT_ENV
export TEST_YEAR=zuros_year1 && echo TEST_YEAR=$TEST_YEAR
