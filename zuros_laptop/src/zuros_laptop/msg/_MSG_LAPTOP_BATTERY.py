"""autogenerated by genpy from zuros_laptop/MSG_LAPTOP_BATTERY.msg. Do not edit."""
import sys
...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.percentage = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.remaining = str[start:end].decode('utf-8')
      else:
        self.remaining = str[start:end]
      return self
